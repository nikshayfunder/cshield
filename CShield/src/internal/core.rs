...
fn allow_path(p: &str) -> bool {
    ...
    if ["/dashboard.html", "/settings.html", "/add_proxy.html", "/proxies.html", "/dashboard", "/settings", "/add_proxy", "/proxies", "/login.html", "/register.html", "/captcha.html"].contains(&p) { return true; }
